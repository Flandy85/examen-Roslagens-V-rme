...
<body <?php body_class(); ?> >
	<header class="nav-down"><!-- class nav-down is for making header to go up when users scroll down -->
		<div class="top-header-container">
			...
			<a href="https://www.aircon.panasonic.eu/GB_en/happening/how-to-become-a-panasonic-pro-partner/" rel="noopener" target="blank"><img src="<?php echo get_template_directory_uri(); ?>/src/images/Panapropartners.png" class="top-header-logotype1" alt="Bild av företaget Panasonic Pro Partners loggo"></a>
