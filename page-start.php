		...
		if(have_posts()) {
			while(have_posts()) {
				...
				<div class="rvft-img-outer-container">
					...
					</div><!-- .rvft-img-inner-container -->

					<!-- This empty div(.placeholder-div) is for in tablet, desktop and bigscreens view flexbox positioning for rvft logo -->
					<div class="placeholder-div"></div>
				</div><!-- .rvft-img-outer-container -->
				<div class="small-title-container">
					<h4><?php echo get_field('text-title'); ?></h4>
				</div><!-- .small-title-container -->

				<!-- Second section, LG pumps, Logo and meny containers -->
				...
				<!-- Third section, Panasonic pumps, Logo and meny containers -->
