	...
	if(have_posts() ){
		...
		<div class="blog-content-singel">
			<div class="blog-info-singel">
				<!-- <div class="blog-img-container-singel">
			...
			<div class="blog-picture-singelpage">
			<?php the_post_thumbnail('home-thumb');?>
			</div>
			<button class="button-read" type="button"><?php echo "<a href=\"javascript:history.go(-1)\">Tillbaka</a>";?></button>
		</div>
