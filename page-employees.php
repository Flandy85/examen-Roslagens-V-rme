...
<div class="employees-grid center">
    <div class="grid-cell">
    	<div class="profile">
    		<img class="profile-pic" src="<?php the_field('employees-pic-one'); ?>">
    	</div>
    </div>
    <div class="grid-cell">
    ...
    <div class="grid-cell">
    	<div class="profile">
		<img class="profile-pic" src="<?php the_field('employees-pic-two'); ?>">
    	</div>
    </div>
    <div class="grid-cell">
...
<div class="employees-grid center">
    <div class="grid-cell">
    	<div class="profile">
		<img class="profile-pic" src="<?php the_field('employees-pic-three'); ?>">
    	</div>
    </div>
    <div class="grid-cell">
    ...
    <div class="grid-cell">
    	<div class="profile">
		<img class="profile-pic" src="<?php the_field('employees-pic-four'); ?>">
    	</div>
    </div>
    <div class="grid-cell">
